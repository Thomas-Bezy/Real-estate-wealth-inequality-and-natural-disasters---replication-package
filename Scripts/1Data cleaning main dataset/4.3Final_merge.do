...
use "$dir/Data/data_housing_2017_full.dta", replace

*rename ID id_log

drop PRICE STAGE SURF

merge n:n id_log using "$dir/Data/id_log_prices2017.dta", generate(merge)
drop if merge==2
drop merge


save "$dir/Data/data_housing_2017_full.dta", replace
