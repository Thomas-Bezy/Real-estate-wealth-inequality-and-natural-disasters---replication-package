...
*Import data
use "$dir/Data/data_housing_2017.dta", replace
...
*Merge for owners
merge n:n id_log using "$dir/Data/premiums_owners.dta", generate(merge)
drop merge
...
*Merge for renters
merge n:n id_log using "$dir/Data/premiums_renters.dta", generate(merge)
drop merge 
...
*Export
save "$dir/Data/data_housing_insurance_2017.dta", replace
