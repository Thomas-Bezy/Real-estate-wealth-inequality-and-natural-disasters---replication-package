...
full_sample=read_dta("0Data/data_for_ML.dta")
...
#Export the data
write_dta(renter,"0Data/premiums_renters.dta")
...
#Export the data
write_dta(owner,"0Data/premiums_owners.dta")